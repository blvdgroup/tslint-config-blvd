...
module.exports = {
  rules: {
    // based on https://github.com/progre/tslint-config-airbnb/blob/200c8529692f5bf584df7b533c4ee8139695e85b/tslint.js
    ...
    // extended rules for tslint + blvd exceptions
    align: [true, 'parameters', 'arguments', 'statements'], // 7.15 exception
    ban: false,
    forin: true,
